...
```console
cd $PROCESSED/jq1/bam_files/FIMO/tomtom/fimo_composites/
...
cp PSWM_family_1_mm10_instances.bigWig main_figure_beds/Bach2_mm10_instances.bigWig
cp PSWM_family_2a_mm10_instances.bigWig main_figure_beds/Klf1_mm10_instances.bigWig
cp PSWM_family_2b_mm10_instances.bigWig 'main_figure_beds/Sp9_mm10_instances.bigWig'
cp PSWM_family_3_mm10_instances.bigWig main_figure_beds/Rorb_mm10_instances.bigWig
cp PSWM_family_4_mm10_instances.bigWig main_figure_beds/RUNX_mm10_instances.bigWig
cp PSWM_family_5_mm10_instances.bigWig main_figure_beds/TEAD4_mm10_instances.bigWig
```
...
dir = '$PROCESSED/jq1/bam_files/FIMO/tomtom/fimo_composites/'
setwd(dir)
...
dir = '$PROCESSED/jq1/bam_files/FIMO/tomtom/fimo_composites/main_figure_beds/'
...
not_different = read.table('$PROCESSED/jq1/bam_files/nondynamic_peaks.bed')
not_different = not_different[not_different$V1 != 'chrM',]
not_different = bedWindow(not_different, half_win)

#all_fimo = data.frame()

for(i in 1:ncol(fimo_scores_atac[,-ncol(fimo_scores_atac)])) {
...
Plot increased only
```R
plotFimoLattice(all_fimo[all_fimo$tf %in% c("Bach2", "Rorb", "RUNX"),],
                num.m = -500, num.p = 500,
...
Plot decreased only
```R
plotFimoLattice(all_fimo[all_fimo$tf %in% c("Klf1", "TEAD4", "Sp9"),],
                num.m = -500, num.p = 500,
...
```
final_atac_all_dt
table(final_atac_all_dt$response_DMSOvJQ1)
<!--    Dynamic Nondynamic
      1093     2102 -->
